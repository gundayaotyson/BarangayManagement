        ...
        <div class="profile-container dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end" style="min-width: 170px;">
                <div class="dropdown-option">
                    <a href="{{ route('resident.profile')}}" class="dropdown-item d-flex align-items-center px-3 py-2 rounded">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('sk.projects') }}" class="{{ request()->routeIs('sk.projects') ? 'active' : '' }}">
                <i class="fas fa-folder me-3"></i> <span>Projects</span>
            </a>
        </li>
        <li>
            <a href="{{ route('sk.services') }}" class="{{ request()->routeIs('sk.services') ? 'active' : '' }}">
                <i class="fas fa-cogs me-3"></i> <span>Services</span>
            </a>
        </li>
