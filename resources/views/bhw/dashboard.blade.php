...
<nav class="sidebar" id="sidebar">
        ...
        <div class="profile-container dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end" style="min-width: 170px;">
                <div class="dropdown-option">
                    <a href="{{ route('bhw.profile')}}" class="dropdown-item d-flex align-items-center px-3 py-2 rounded">
    ...
    <ul>
        ...
        <li><a href="{{ route('bhw.Requestlist') }}"class="{{ request()->routeIs('bhw.Requestlist') ? 'active' : '' }}"><i class="fas fa-file-alt"></i> <span>Services Request List</span></a></li>
