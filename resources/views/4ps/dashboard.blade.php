...
<nav class="sidebar" id="sidebar">
        ...
        <div class="profile-container dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end" style="min-width: 170px;">
                <div class="dropdown-option">
                    <a href="{{ route('4ps.profile') }}" class="dropdown-item d-flex align-items-center px-3 py-2 rounded">
    ...
    <ul>
        ...
        <li><a href="{{ route('4ps.residentlist') }}" class="{{ request()->routeIs('4ps.residentlist') ? 'active' : '' }}"><i class="fas fa-users"></i> <span>Residents List</span></a></li>
    </ul>
</nav>
