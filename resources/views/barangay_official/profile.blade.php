...
<div class="container profile-container">
        ...
        <div class="card-body">
            <form action="{{ route('partials.profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="profile-img-container">
                    <img src="{{ isset($user) && $user->image ? asset('storage/profile_images/' . $user->image) : asset('images/default.png') }}"
    ...
    <div class="text-center">
        <a href="{{ route('barangay_official.dashboard') }}" class="btn btn-back">
