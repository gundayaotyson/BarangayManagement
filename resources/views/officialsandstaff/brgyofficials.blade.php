...
@section('content')
    ...
    /* Keep your existing modal and other styles below... */
    /* View Resident Modal Styles, Animation, etc. remain the same */
</style>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @foreach($officials as $official)
                                <tr>
                                    <td class="fw-semibold">{{ $official->fname }} {{ $official->mname }} {{ $official->lname }}</td>
                                    ...
                                    <td class="action-column">
                                        <button class="btn btn-warning btn-sm editOfficialBtn" data-bs-toggle="modal"
                                            ...
                                            data-fname="{{ $official->fname }}"
                                            data-mname="{{ $official->mname }}"
                                            data-lname="{{ $official->lname }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // When modal hides, clean up leftover backdrops
